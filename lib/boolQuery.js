...
function processAppender(obj, type, field) {
    ...
    return obj.factory(obj.applyQuery.bind(obj, type), field, { type: obj.conditionalState });
}
...
BoolQuery.prototype.applyQuery = function (key, query, gen) {
...
BoolQuery.prototype.isCompatible = function (obj) {
    ...
    return theirGenerator instanceof myGenerator.constructor;
};
